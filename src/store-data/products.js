...
const products = [
    {
        ...
        dresstag: 'ao-somi',
        colors: ['Trắng', 'Đỏ'],
        tag: 'ao-somi-nam-tay-dai-keisha',
        size: ['s', 'm', 'xl'],
        sex: 'male',
        isBestSeller: true,
        description:
    ...
    },
    {
        ...
        dresstag: 'ao-somi',
        colors: ['Xanh', 'Đen'],
        tag: 'ao-so-mi-nam-tay-ngan-melange',
        size: ['s', 'l', 'xl'],
        sex: 'male',
        isNewProduct: true,
        description:
    ...
    },
    {
        ...
        tag: 'ao-so-mi-nu-tay-dai-ke-soc-caro',
        size: ['l', 'xl'],
        sex: 'female',
        isBestSeller: true,
        description:
    ...
    },
    {
        ...
        dresstag: 'ao-somi',
        colors: ['Trắng', 'Đỏ', 'Đen'],
        tag: 'ao-so-mi-nu-tay-dai-cong-so',
        size: ['s', 'm', 'xl'],
        sex: 'female',
        isNewProduct: true,
        description:
    ...
    },
    {
        ...
        dresstag: 'ao-somi',
        colors: ['Trắng', 'Xanh'],
        tag: 'ao-so-mi-nu-tay-dai-dang-suong',
        size: ['m'],
        sex: 'female',
        isNewProduct: true,
        description:
    ...
    },
    {
        ...
        dresstag: 'quan-jean',
        colors: ['Xanh', 'Đen'],
        tag: 'quan-jean-nu-dang-skinny-tron',
        size: ['l'],
        sex: 'female',
        isNewProduct: true,
        description:
    ...
    },
    {
        ...
        dresstag: 'quan-jean',
        colors: ['Xanh'],
        tag: 'quan-jean-nu-lung-cao-xuoc-nhe',
        size: ['s', 'm', 'xl'],
        sex: 'female',
        isBestSeller: true,
        description:
    ...
    },
    {
        ...
        dresstag: 'ao-somi',
        colors: ['Trắng', 'Vàng'],
        tag: 'ao-so-mi-nam-tay-ngan-slimfit',
        size: ['s', 'l', 'xl'],
        sex: 'male',
        description:
            '- Áo Sơ Mi Nam Tay Ngắn Slimfit Chất Liêu 100% Coolmax Phối Viền Năng Động, Trẻ Trung, Nam Tính có thiết kế kiểu dáng cơ bản với dáng ôm vừa, cổ bẻ, tay ngắn in logo 5S, kiểu dáng thể thao <br><br> - Áo Sơ Mi Nam Tay Ngắn Slimfit Chất Liêu 100% Coolmax Phối Viền Năng Động, Trẻ Trung, Nam Tính, dễ dàng phối cùng quần jeans hoặc shorts, giày thể thao hoặc giày lười, thích hợp sử dụng trong các dịp đi chơi, gặp gỡ bạn bè và các hoạt động ngoài trời.',
    },
]

const getAllProducts = () => products

const getProductsBySlice = (start, end) => {
    return products.slice(start, end)
}

const getProductBytag = (tag) => products.find((e) => e.tag === tag)

export { getAllProducts, getProductsBySlice, getProductBytag }
